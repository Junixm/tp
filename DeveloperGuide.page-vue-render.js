...
with(this){return _c('p',[_v("HRQuickAccess is based on the AddressBook-Level3 application. Learn more about the project "),_c('a',{attrs:{"href":"https://se-education.org/addressbook-level3/"}},[_v("here")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Refer to the guide "),_c('a',{attrs:{"href":"https://ay2425s2-cs2103t-t15-1a.github.io/tp/SettingUp.html"}},[_c('em',[_v("Setting up and getting started")])]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-T15-1a/tp/blob/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-T15-1a/tp/blob/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" component,")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("can save both address book data and user preference data in JSON format, and read them back into corresponding objects.")]),_v(" "),_c('li',[_v("inherits from both "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookStorage")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UserPrefStorage")]),_v(", which means it can be treated as either one (if only the functionality of only one is needed).")]),_v(" "),_c('li',[_v("stores data in a local JSON file located at "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("/data/addressbook.json")]),_v(".")]),_v(" "),_c('li',[_v("depends on some classes in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" component (because the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" component's job is to save/retrieve objects that belong to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(")")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"reassign-command"}},[_v("Reassign Command"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#reassign-command","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("API")]),_v(": "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-T15-1a/tp/blob/master/src/main/java/seedu/address/logic/commands/ReassignCommand.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ReassignCommand.java")])])])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Reassign")]),_v(" feature, allows the reassigning of personnel's duties.")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Command input entered by the user is passed through the UI component.")]),_v(" "),_c('li',[_v("The UI component calls the execute function in the class "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ReassignCommand")]),_v(".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ReassignCommand")]),_v(" will then unassign the old duty and then assign the new duty to the target personnel.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ReassignCommand")]),_v(" returns the command execution result back to UI.")]),_v(" "),_c('li',[_v("Finally, the UI component shows the updated entry to the user.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"edit-command"}},[_v("Edit Command"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#edit-command","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("API")]),_v(": "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-T15-1a/tp/blob/master/src/main/java/seedu/address/logic/commands/EditCommand.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand.java")])])])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Edit")]),_v(" feature allows users to edit existing personnel's entry information.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("During the process of an edit command, a "),_c('strong',[_v("personToEdit")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" object would be referenced to store the attributes of the target entry.\nAdditionally, an "),_c('strong',[_v("updatedPerson")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" object would be created which represents the new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" object to replace "),_c('strong',[_v("personToEdit")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('strong',[_v("updatedPerson")]),_v(" objects will have the new updated attributes indicated by the user, while the rest of the attributes which are not edited would be storing "),_c('strong',[_v("personToEdit")]),_v(" original attribute.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("In the given UML diagram example, it can be seen that the "),_c('strong',[_v("updatedPerson")]),_v("'s "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Duty")]),_v(" object is still the same as the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Duty")]),_v(" object from "),_c('strong',[_v("personToEdit")]),_v(", while updated attributes such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Rank")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Company")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Address")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Name")]),_v(" are different objects.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(": "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103T-T15-1a/tp/blob/master/src/main/java/seedu/address/logic/commands/FilterCommand.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FilterCommand.java")])])])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Filter")]),_v(" feature allows users to filter personnel's entry according to their "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Company")]),_v(" attribute.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FilterCommand")]),_v(" uses the class "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CompanyContainsKeywordsPredicate")]),_v(" which in turn tests a given "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" object to find out whether they fit the keyword given.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("This way, the feature is able to filter out entries that are not from the intended "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Company")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('a',{attrs:{"href":"https://ay2425s2-cs2103t-t15-1a.github.io/tp/Documentation.html"}},[_v("Documentation guide")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"https://ay2425s2-cs2103t-t15-1a.github.io/tp/Testing.html"}},[_v("Testing guide")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"https://ay2425s2-cs2103t-t15-1a.github.io/tp/Logging.html"}},[_v("Logging guide")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"https://ay2425s2-cs2103t-t15-1a.github.io/tp/Configuration.html"}},[_v("Configuration guide")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"https://ay2425s2-cs2103t-t15-1a.github.io/tp/DevOps.html"}},[_v("DevOps guide")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("HRQuickAccess provides HR personnel with fast, keyboard-focused access to essential troop information, including contact details and duty dates")]),_v(" "),_c('p',[_c('strong',[_v("Rationale")]),_v(": The Singapore Armed Forces (SAF) primarily issue and utilize laptops with security cards within army camps; as such, tech accessories such as mouses and additional monitors are less common and applicable. Through command line interface (CLI) interface, we can overcome this constraint")])]),_v(" "),_c('li',[_c('p',[_v("HRQuickAccess does not require internet access to operate, as all its data is stored locally instead of remotely")]),_v(" "),_c('p',[_c('strong',[_v("Rationale")]),_v(": SAF-issued laptops cannot be connected to the internet (less INET laptops) for security reasons. By having a local database, we can work around this constraint")])]),_v(" "),_c('li',[_c('p',[_v("HRQuickAccess offers a better alternative to the current system of using Microsoft Excel, which is prone to human errors, by offering ease of use, quick lookups, and smooth updates, as well as a clean interface")]),_v(" "),_c('p',[_c('strong',[_v("Rationale")]),_v(": There are currently no better alternatives for HR staff who prefer a fast, typing-focused workflow, leaving many to rely on Microsoft Excel. However, Excel is prone to human error, inefficient for quick lookups, and cumbersome for regular updates")])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a/an …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("S1 Branch Staff")]),_v(" "),_c('td',[_v("add entries")]),_v(" "),_c('td',[_v("add contacts into the address book")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("S1 Branch Staff")]),_v(" "),_c('td',[_v("delete entries")]),_v(" "),_c('td',[_v("remove contacts from the address book")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("S1 Branch Staff")]),_v(" "),_c('td',[_v("view entries")]),_v(" "),_c('td',[_v("see a person's details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("S1 Branch Staff")]),_v(" "),_c('td',[_v("assign duties")]),_v(" "),_c('td',[_v("assign more duties to a personnel")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("S1 Branch Staff")]),_v(" "),_c('td',[_v("have a cleaner GUI (i.e concise, minimalistic)")]),_v(" "),_c('td',[_v("not get tired looking at the app all day.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("S1 Branch Staff")]),_v(" "),_c('td',[_v("be able to add pictures to profile entries")]),_v(" "),_c('td',[_v("recognize the entries easily.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("S1 Branch Staff")]),_v(" "),_c('td',[_v("have a quick search function using partial names or keywords")]),_v(" "),_c('td',[_v("find personnel even if I don’t remember their full details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("S1 Branch Staff")]),_v(" "),_c('td',[_v("quickly access and update the duty dates of troops")]),_v(" "),_c('td',[_v("efficiently manage scheduling, deployments, and rotations without delays.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user from the S1 Branch")]),_v(" "),_c('td',[_v("have a filter feature")]),_v(" "),_c('td',[_v("so that I can filter the companies of personnel that I want to know about.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HRQuickAccess")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Branch Staff")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-uc1-add-a-new-personnel-s-entry"}},[_c('strong',[_v("Use Case: UC1 - Add a new personnel’s entry")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-uc1-add-a-new-personnel-s-entry","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("The system must be on the home page.")]),_v(" "),_c('li',[_v("The system must be able to connect to its local database without issues.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The branch staff types a command to add a new personnel entry, including all required details.")]),_v(" "),_c('li',[_v("The system adds the personnel’s entry with the provided details.")]),_v(" "),_c('li',[_v("The system displays a success message to the branch staff.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The branch staff provides insufficient input.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. The system displays an error message indicating the required fields and correct format to enter.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The system detects invalid information entered.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. The system states one invalid field and provides the correct format to enter.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. The system detects a duplicate personnel.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. The system displays an error message stating that the entry already exists.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-uc2-view-a-personnel-s-entry"}},[_c('strong',[_v("Use Case: UC2 - View a personnel’s entry")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-uc2-view-a-personnel-s-entry","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions:")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("The branch staff request to view a personnel’s entry.")])]),_v(" "),_c('li',[_c('p',[_v("The branch staff enters the details of the personnel.")])]),_v(" "),_c('li',[_c('p',[_v("The system shows the personnel’s entry.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The branch staff provides insufficient input.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. The system displays an error message indicating the required fields and correct format to enter.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. The system detects invalid information in the provided details.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. The system states the incorrect fields and provides the correct format to enter.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("2c. The system identifies that there isn’t such personnel.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2c1. The system displays an error message stating that the personnel cannot be found.")]),_v(" "),_c('p',[_v("Use case end.")])])])]),_v(" "),_c('li',[_c('p',[_v("2d. The system found that there are multiple personnel's entries.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2d1. The system displays a list of matching personnel and asks which entry to view.")])]),_v(" "),_c('li',[_c('p',[_v("2d2. The branch staff selects the specific entry to view.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-uc3-delete-a-personnel-s-entry"}},[_c('strong',[_v("Use Case: UC3 - Delete a personnel’s entry")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-uc3-delete-a-personnel-s-entry","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions:")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("The branch staff types a command to delete a specify personnel.")]),_v(" "),_c('li',[_v("The system deletes the entry from the database.")]),_v(" "),_c('li',[_v("The system displays a success message and indicates the deleted person to the branch staff\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("The branch staff request to add duty to a personnel’s entry.")])]),_v(" "),_c('li',[_c('p',[_v("The branch staff enters the duty’s details of the personnel.")])]),_v(" "),_c('li',[_c('p',[_v("The system assigns the duty to the personnel’s entry.")])]),_v(" "),_c('li',[_c('p',[_v("The system displays a success message to the branch staff and shows related changes.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The branch staff provides insufficient input.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. The system displays an error message indicating the required fields and correct format to enter.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. The system detects invalid information in the provided details.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. The system states the incorrect fields and provides the correct format to enter.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("2c. The system identifies that there isn’t such personnel.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2c1. The system displays an error message stating that the personnel cannot be found and thus cannot be assigned a duty.")]),_v(" "),_c('p',[_v("Use case end.")])])])]),_v(" "),_c('li',[_c('p',[_v("2d. The system found that there are multiple personnels’ entries.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2d1. The system displays a list of matching personnel and asks which entry to assign a duty to.")])]),_v(" "),_c('li',[_c('p',[_v("2d2. The branch staff selects the specific entry to assign a duty to.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("The system should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("The system should remain usable with a battalion-level number of entries (approximately 500–800 people).")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Error messages should avoid jargons that non-technical users may not understand, while omitting explanations of military jargon, as they are already familiar with them.")]),_v(" "),_c('li',[_v("Entries’ data should be stored locally.")]),_v(" "),_c('li',[_v("The application should remain usable without internet access at all times.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Battalion")]),_v(": A large military unit consisting of multiple companies, typically includes 500 to 800 soldiers. It is usually commanded by a battalion commander and forms a key component within a brigade or regiment.")]),_v(" "),_c('li',[_c('strong',[_v("Company")]),_v(": A military unit made up of several platoons, usually commanded by a captain. In Singapore Armed Forces, a company generally comprises around 100 to 150 soldiers.")]),_v(" "),_c('li',[_c('strong',[_v("Platoon")]),_v(": A smaller military unit consisting of a few squads, typically led by a lieutenant. Platoons usually include 20 to 50 soldiers and serve as the basic building blocks of a company.")]),_v(" "),_c('li',[_c('strong',[_v("Rank")]),_v(": The hierarchical level or position of a soldier or officer within the military. Ranks indicate authority, responsibilities, and career progression.")]),_v(" "),_c('li',[_c('strong',[_v("Duties")]),_v(": The scheduled assignments or tasks for soldiers during a particular month, including specific dates and the maximum number of working hours allowed per month.")]),_v(" "),_c('li',[_c('strong',[_v("Masked NRIC")]),_v(": A version of a soldier's National Registration Identity Card (NRIC) number where certain digits or characters are redacted to comply with PDPR regulations and protect sensitive personal information.")]),_v(" "),_c('li',[_c('strong',[_v("Branch Staff")]),_v(": Personnel responsible for managing human resources within a battalion or across the army. They handle administrative tasks, maintain personnel entries, and coordinate manpower for military operations.")]),_v(" "),_c('li',[_c('strong',[_v("Personnel")]),_v(": Refers to all individuals serving in the military, including recruits, soldiers, and other service members in Singapore who are either fulfilling National Service requirements or serving voluntarily.")]),_v(" "),_c('li',[_c('strong',[_v("National Service (NS)")]),_v(": A mandatory service program for eligible Singaporean citizens and permanent residents, involving military training and service in the Singapore Armed Forces.")]),_v(" "),_c('li',[_c('strong',[_v("Duty Date")]),_v(": A specific calendar day where a soldier is scheduled to perform assigned tasks or responsibilities. Each soldier can only perform duty on a limited number of days within the same month, as regulated by SAF policies.")]),_v(" "),_c('li',[_c('strong',[_v("INET Laptops")]),_v(": Official laptops provided by SAF for secure internet access in designated areas.")]),_v(" "),_c('li',[_c('strong',[_v("S1 Branch")]),_v(": A branch in the SAF which handles manpower and personnel matters.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Dealing with missing/corrupted data files")]),_v(" "),_c('ol',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("preferences.json")]),_v(" "),_c('ol',[_c('li',[_v("Move the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("preferences.json")]),_v(" file to a different location.")]),_v(" "),_c('li',[_v("Relaunch the app."),_c('br'),_v("\nExpected: A new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("preferences.json")]),_v(" file is created with default preferences.")])])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("config.json")]),_v(" "),_c('ol',[_c('li',[_v("Move the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("config.json")]),_v(" file to a different location.")]),_v(" "),_c('li',[_v("Relaunch the app."),_c('br'),_v("\nExpected: A new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("config.json")]),_v(" file is created with default preferences.")])])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressbook.json")]),_v(" "),_c('ol',[_c('li',[_v("Missing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressbook.json")]),_v(" "),_c('ol',[_c('li',[_v("Move the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressbook.json")]),_v(" file to a different location.")]),_v(" "),_c('li',[_v("Relaunch the app."),_c('br'),_v("\nExpected: Application loads with sample data.")])])]),_v(" "),_c('li',[_v("Corrupted "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressbook.json")]),_v(" "),_c('ol',[_c('li',[_v("Corrupt the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressbook.json")]),_v(" file by adding some random text.")]),_v(" "),_c('li',[_v("Relaunch the app."),_c('br'),_v("\nExpected: Applications loads without any data.")])])])])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"acknowledgement"}},[_v("Acknowledgement"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#acknowledgement","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Tue, 8 Apr 2025, 1:09:48 GMT+8]")])])])}
}];
